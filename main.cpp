...
int main(int argc, char* argv[]) {
    ...
    if (argc != 11) {
        std::cout << "please type the input as int start_node, int target_node, int total_nodes, double alpha, double gamma, int distribution_type, double random_index_1, double random_index_2, int sample_size, int greedy type" << std::endl;
        return 1;
    }
